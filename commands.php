...
?>
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title" data-i18n="mnu_commands">Commands</h3>
					...
					<div class="tab-content">							  
					    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary" name="btnSend"><span data-i18n="button_send">Send</span><i class="icon-arrow-right14 position-right"></i></button>
                                &nbsp; &nbsp; &nbsp;
				    ...
				    <table class="table datatable-js" id="datatable">
                        <thead>
                            <tr>                                                	                            	
                                ...
                                <th data-i18n="title_result">Result</th>
                            </tr>
                        </thead>
                    </table>							  							
				</div>
