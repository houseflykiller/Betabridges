...
function doPrepareTrips() {
   ...
   //prepare list devices
	...
	$.ajax({
		type : "GET",
		url : sessionStorage.getItem('url') + "reports/trips",
		data:params,
        ...
        success: function (response) {
            ...
            $('.datatable-js').dataTable({
		        ...
		        buttons: [{extend: 'excelHtml5',
			               title: $.i18n("title_reports_trips")
			              },{
                            extend: 'print',
