...
?>
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title" data-i18n="title_reports_inputs">Report Inputs</h3>
						    ...
						    <div class="row">
					            <div class="col-md-4">                                                       
						            <div class="form-group">
                                        ...
                                        <input type="text" id="from" name="from" class="form-control datetimepicker" maxlength="20" placeholder="" data-mask="99/99/9999 99:99:99" />  <label for="from" style="font-weight:normal" data-i18n="title_to">To</label>
	...
	<script src="assets/js/apps/commons/inputs.js"></script>
