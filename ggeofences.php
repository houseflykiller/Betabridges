...
?>
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" data-i18n="title_groups_geofences">Groups Geofences</h3>
							  ...
							  <div id="tab_list" class="tab-pane fade">
							    ...
							    <div class="panel-heading">							                            
	                         	...
	                         	<div class="row">
							    	<div class="col-md-4">
										<div class="form-group">
						                    <label style="font-weight:normal" data-i18n="title_search_group">Search Group</label>
						                    <select class="select-find" id="groupIdFind" name="groupIdFind">											                    											                    											                    
								                    <option value="" data-i18n="title_select2">Select an option...</option>											                    
						                    </select>
					                    </div>
					                </div>
	...
	<script src="assets/js/apps/commons/ggeofences.js"></script>
