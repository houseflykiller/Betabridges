...
?>
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title" data-i18n="title_reports_trips">Report Trips</h3>
				    ...
				    <table class="table datatable-js" id="datatable">
                        <thead>
                            <tr>                                                	            			        
                                ...
                                <!--<th data-i18n="title_spent_fuel">Spent Fuel</th>-->
                            </tr>
                        </thead>
                    </table>							  							
				</div>
	...
	<script src="assets/js/apps/commons/trips.js"></script>
