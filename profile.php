...
?>
			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="panel panel-profile" id="panel_profile" style="height: 950px;">
						<div class="clearfix">
							<!-- LEFT COLUMN -->
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<form id="formPhoto" method="post" enctype="multipart/form-data">
											<img id="profile_photo" src="assets/img/user.png" class="img-circle" alt="Avatar" style="height: 90px; width: 90px; cursor: pointer;" onclick="setImagePhoto()"  title="Click">
...
-->									
									...
									<div class="text-center"><a name="btnEditProfile" href="#" class="btn btn-primary">Edit Profile</a></div>
								</div>
								<!-- END PROFILE DETAIL -->
							</div>
									...
									<div class="tab-pane fade" id="tab_form">
										...
										<form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
											...
											<div class="row">
									            <div class="col-md-4">						                    
								                    <div class="form-group">
									                    <label style="font-weight:normal" data-i18n="mnu_language">Language</label>
									                    <select class="select-search" id="language" name="language">	
									                    		<option value="" data-i18n="title_select2">Select an option...</option>									                    											   		                    
											                    <option value="en" data-i18n="mnu_english">English</option>							                    
									                    </select>
								                    </div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-14">											
													...
													<div class="col-md-3">
														<div class="form-group">
															<label for="alcohol" style="font-weight:normal" data-i18n="title_alcohol">Ethanol</label>
													...
													<div class="col-md-3">
														<div class="form-group">
															<label for="gnv" style="font-weight:normal" data-i18n="title_gnv">CNG</label>
