...
?>
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" data-i18n="title_devices_aliases">Devices Aliases</h3>
							  ...
							  <div id="tab_form" class="tab-pane fade in active">
							    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
                					    ...
                					    <div class="form-group">
						                    <label style="font-weight:normal" data-i18n="title_attribute">Attribute</label>
						                    <select class="select-search" id="attributeId" name="attributeId">											                    											                    											                    
							  ...
							  <div id="tab_list" class="tab-pane fade">
							    ...
							    <div class="panel-heading">							                            
	                         	...
	                         	<div class="row">
							    	<div class="col-md-4">
										<div class="form-group">
						                    <label style="font-weight:normal" data-i18n="title_search_device">Search Device</label>
						                    <select class="select-find" id="deviceIdFind" name="deviceIdFind">											                    											                    											                    
								                    <option value="" data-i18n="title_select2">Select an option</option>											                    
						                    </select>
					                    </div>
					                </div>
                                ...
                                <table class="table datatable-js" id="datatable">
		                            <thead>
			                            <tr>
                                            ...
                                            <th data-i18n="title_description">Name</th>
                                            <th>&nbsp;</th>
                                        </tr>
		                            </thead>
	                            </table>
	...
	<script src="assets/js/apps/commons/daliases.js"></script>
