			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					...
					<div class="right">
						...
						<h1 class="heading" data-i18n="recover_message">Recover Password.</h1>
							<p data-i18n="recover_sub_message">Enter your email and a new access password will be sent to your email address!</p>
						</div>
					</div>
