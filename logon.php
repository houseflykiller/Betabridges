...
?>
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title" data-i18n="title_reports_access">Report Access</h3>
				    ...
				    <table class="table datatable-js" id="datatable">
                        <thead>
                            <tr>                                                	            			        
								...
								<th data-i18n="title_count_access">Count Access</th>
								<th data-i18n="title_last_login">Last Login</th>								
                            </tr>
                        </thead>
                    </table>							  							
				</div>
	...
	<script src="assets/js/apps/commons/logon.js"></script>
