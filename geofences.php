...
?>			
							  ...
							  <div id="tab_form" class="tab-pane fade in active">
							    <form id="form_data" method="post" action="#" enctype="application/x-www-form-urlencoded"  role="form" >
									    ...
									    <div class="form-group">									    	
											...
											<div id="mapgeo"></div>											
											<div id="search">
												<!--<label for="addr" style="font-weight:normal; font-size: 14px; color: #fff; font-weight: bold" data-i18n="title_search">Local</label><br />-->
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBH_hm3-3-Ln5rRtKE3FJvCMaa59ySsqJ0&v=3&sensor=false"></script>
